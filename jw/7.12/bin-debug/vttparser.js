...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! parsers/captions/vttcue */ 48)], __WEBPACK_AMD_DEFINE_RESULT__ = function (VTTCue) {
	    ...
	    var requestFrame = window.requestAnimationFrame || function (rafFunction) {
	        return window.setTimeout(rafFunction, 17);
	    };
	
	    var VTTParser = function VTTParser(window, decoder) {
	        this.window = window;
	        this.state = 'INITIAL';
	        this.buffer = '';
...
//# sourceMappingURL=vttparser.a8bf8f3cb1a82cfe5f6e.map
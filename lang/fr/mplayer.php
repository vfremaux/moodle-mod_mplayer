...
$string['numpasspoints'] = 'Nombre de balises de visionnage';
$string['passrule'] = 'Règle pour compléter';
$string['passrulenone'] = 'Pas de surveillance du visionnage';
...
$string['showpasspoints'] = 'Afficher les balises de visionnage';

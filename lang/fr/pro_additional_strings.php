...
require_once($CFG->dirroot.'/mod/mplayer/lib.php'); // to get xx_supports_feature();
if ('pro' == mplayer_supports_feature()) {
    include($CFG->dirroot.'/mod/mplayer/pro/lang/fr/pro.php');
}

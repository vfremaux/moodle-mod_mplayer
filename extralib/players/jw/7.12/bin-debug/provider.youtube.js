...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! utils/helpers */ 8), __webpack_require__(/*! utils/css */ 16), __webpack_require__(/*! utils/underscore */ 6), __webpack_require__(/*! events/events */ 32), __webpack_require__(/*! events/states */ 31), __webpack_require__(/*! utils/scriptloader */ 55), __webpack_require__(/*! providers/default */ 35), __webpack_require__(/*! utils/backbone.events */ 29)], __WEBPACK_AMD_DEFINE_RESULT__ = function (utils, cssUtils, _, events, states, Scriptloader, DefaultProvider, Events) {
	    ...
	    function YoutubeProvider(_playerId, _playerConfig) {
	        ...
	        function _checkPlaybackHandler() {
	            ...
	            if (youtubeState !== null && youtubeState !== undefined && youtubeState !== _youtubeState) {
	        ...
	        function _onYoutubeStateChange(event) {
	            ...
	            switch (_youtubeState) {
	                ...
	                case youtubeStates.CUED:
	                    // 5: //video cued (idle before playback)
	        ...
	        function _setItem(item) {
	            ...
	            if (!_youtubeAPI || !_youtubePlayer) {
	                ...
	                _youtubeEmbedReadyCallback = function _youtubeEmbedReadyCallback() {
	        ...
	        this.remove = function () {
	            ...
	            _youtubeEmbedReadyCallback = _youtubePlayerReadyCallback = _youtubePlayer = null;
	        };
...
//# sourceMappingURL=provider.youtube.a8bf8f3cb1a82cfe5f6e.map
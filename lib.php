...
function mplayer_scale_used_anywhere($scaleid) {
    ...
    if ($scaleid and $DB->record_exists('mplayer', array('grade' => -$scaleid))) {
        return true;
    } else {
        return false;
    }
...
function mplayer_set_paths($mplayer) {
    ...
    if ($mplayer->configxml != '') {
        $mplayer->configxml = '$config='.mplayer_get_file_url($mplayer, 'configxml').'?'.$mplayer_time;
    }
...
//// --------------------------------------------------------- AUDIO DESCRIPTION ---------------------------------------------------------
    ...
    if ($mplayer->audiodescriptionfile == '') {
        ...
        $mplayer->audiodescriptionfile = '&audiodescription.file='.mplayer_get_file_url($mplayer, 'audiodescriptionfile');
    ...
    if ($mplayer->captionsfile != '') {
        ...
        $mplayer->captionsfile = '&captions.file='.mplayer_get_file_url($mplayer, 'captionsfile');
    ...
    // Check for hdfile
    $hdurl = mplayer_get_file_url($mplayer, 'hd');
    if ($mplayer->hdfile != '') {
        $mplayer->hdbitrate = '&hd.bitrate='.$mplayer->hdbitrate;
        $mplayer->hdfile = '&hd.file='.mplayer_get_file_url($mplayer, 'hdfile');
    ...
    if ($mplayer->livestreamfile != '') {
        $mplayer->livestreamfile = '&livestream.file='.mplayer_get_file_url($mplayer, 'livestreamfile');
        $mplayer->livestreamimage = '&livestream.image='.mplayer_get_file_url($mplayer, 'livestreamimagefile');
    ...
    if ($mplayer->logoboxfile != '') {
        ...
        $mplayer->logoboxfile = '&logobox.file='.mplayer_get_file_url($mplayer, 'logobox');
    ...
    // Check for logo
    $logourl = mplayer_get_file_url($mplayer, 'logo');
    if ($logourl) {
        $mplayer->logofile = '&logo.file='.$logourl;
...
function mplayer_print_body_flashvars($mplayer) {
    ...
    $mplayer_flashvars = '<param name="flashvars" value="'.
                ...
                $mplayer->mplayerdate.
                $mplayer->description.
                '&file='.mplayer_get_file_url($mplayer, 'mplayerfile').
                $mplayer->frontcolor.
                $mplayer->hdbitrate.
                $mplayer->hdfile.
                $mplayer->hdfullscreen.
...
function mplayer_print_body($mplayer) {
    ...
    $mplayerfileurl = mplayer_get_file_url($mplayer, 'mplayer');
                ...
                <!--<![endif]-->
                    <div align="center">
                        <video controls="controls"  height="'.$mplayer->height.'" id="container" poster="'.$mplayer->image.'" width="'.$mplayer->width.'">
                            <source src="'.$mplayerfileurl.'" type="video/mp4" />
                            <source src="'.$mplayerfileurl.'.ogg" type="video/ogg" />
